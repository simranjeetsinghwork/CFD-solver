...
!Grid input parameters
 integer :: nx = 40          !# of nodes around the airfoil (odd number)
...
!Local variables
 ...
 if (igrid==1) then
  nx = 40
  ny = 40
  grid_file_tria = "cylinder_040x040_tria.grid"
   tec_file_tria = "cylinder_040x040_tria_tec.dat"
   vtk_file_tria = "cylinder_040x040_tria.vtk"
  grid_file_quad = "cylinder_040x040_quad.grid"
   tec_file_quad = "cylinder_040x040_quad_tec.dat"
   vtk_file_quad = "cylinder_040x040_quad.vtk"
 elseif (igrid==2) then
  nx = 80
  ny = 40
